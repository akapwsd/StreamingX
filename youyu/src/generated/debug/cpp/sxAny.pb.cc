...
void protobuf_AssignDesc_sxAny_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_sxAny_2eproto() {
  protobuf_AddDesc_sxAny_2eproto();
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_sxAny_2eproto);
}
...
void protobuf_ShutdownFile_sxAny_2eproto() {
  Any_default_instance_.Shutdown();
  delete Any_reflection_;
}

void protobuf_InitDefaults_sxAny_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_sxAny_2eproto_once_);
void protobuf_InitDefaults_sxAny_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_sxAny_2eproto_once_,
                 &protobuf_InitDefaults_sxAny_2eproto_impl);
}
void protobuf_AddDesc_sxAny_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_sxAny_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013sxAny.proto\022\017google.protobuf\"&\n\003Any\022\020\n"
    "\010type_url\030\001 \001(\t\022\r\n\005value\030\002 \001(\014Bv\n\023com.go"
    "ogle.protobufB\010AnyProtoP\001Z,google.golang"
    ".org/protobuf/types/known/anypb\242\002\003GPB\252\002\036"
    "Google.Protobuf.WellKnownTypesb\006proto3", 198);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "sxAny.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_sxAny_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_sxAny_2eproto_once_);
void protobuf_AddDesc_sxAny_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_sxAny_2eproto_once_,
                 &protobuf_AddDesc_sxAny_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_sxAny_2eproto {
  StaticDescriptorInitializer_sxAny_2eproto() {
    protobuf_AddDesc_sxAny_2eproto();
  }
} static_descriptor_initializer_sxAny_2eproto_;
...
Any::Any()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_sxAny_2eproto();
  SharedCtor();
