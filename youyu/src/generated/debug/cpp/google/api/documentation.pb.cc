...
void protobuf_AssignDesc_google_2fapi_2fdocumentation_2eproto() {
  ...
  static const int Documentation_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Documentation, service_root_url_),
...
const int Documentation::kServiceRootUrlFieldNumber;
...
void Documentation::SharedCtor() {
  ...
  service_root_url_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void Documentation::SharedDtor() {
  ...
  service_root_url_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:google.api.Documentation)
  ...
  service_root_url_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(50)) goto parse_service_root_url;
        break;
      }
      ...
      case 6: {
        if (tag == 50) {
         parse_service_root_url:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_service_root_url()));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->service_root_url().data(), this->service_root_url().length(),
            ::google::protobuf::internal::WireFormatLite::PARSE,
...
void Documentation::SerializeWithCachedSizes(
  ...
  // optional string service_root_url = 6;
  if (this->service_root_url().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->service_root_url().data(), this->service_root_url().length(),
      ::google::protobuf::internal::WireFormatLite::SERIALIZE,
      "google.api.Documentation.service_root_url");
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      6, this->service_root_url(), output);
  }
...
::google::protobuf::uint8* Documentation::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->service_root_url().size() > 0) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        6, this->service_root_url(), target);
  }
...
void Documentation::UnsafeMergeFrom(const Documentation& from) {
  ...
  if (from.service_root_url().size() > 0) {

    service_root_url_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.service_root_url_);
  }
...
void Documentation::InternalSwap(Documentation* other) {
  ...
  service_root_url_.Swap(&other->service_root_url_);
...
// optional string service_root_url = 6;
void Documentation::clear_service_root_url() {
  service_root_url_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
const ::std::string& Documentation::service_root_url() const {
  // @@protoc_insertion_point(field_get:google.api.Documentation.service_root_url)
  return service_root_url_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
void Documentation::set_service_root_url(const ::std::string& value) {
  
  service_root_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:google.api.Documentation.service_root_url)
}
void Documentation::set_service_root_url(const char* value) {
  
  service_root_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:google.api.Documentation.service_root_url)
}
void Documentation::set_service_root_url(const char* value, size_t size) {
  
  service_root_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:google.api.Documentation.service_root_url)
}
::std::string* Documentation::mutable_service_root_url() {
  
  // @@protoc_insertion_point(field_mutable:google.api.Documentation.service_root_url)
  return service_root_url_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* Documentation::release_service_root_url() {
  // @@protoc_insertion_point(field_release:google.api.Documentation.service_root_url)
  
  return service_root_url_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
void Documentation::set_allocated_service_root_url(::std::string* service_root_url) {
  if (service_root_url != NULL) {
    
  } else {
    
  }
  service_root_url_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), service_root_url);
