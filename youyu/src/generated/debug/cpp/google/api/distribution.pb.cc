...
const ::google::protobuf::Descriptor* Distribution_Exemplar_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  Distribution_Exemplar_reflection_ = NULL;
...
void protobuf_AssignDesc_google_2fapi_2fdistribution_2eproto() {
  ...
  static const int Distribution_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Distribution, exemplars_),
  };
  ...
  Distribution_Exemplar_descriptor_ = Distribution_descriptor_->nested_type(2);
  static const int Distribution_Exemplar_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Distribution_Exemplar, value_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Distribution_Exemplar, timestamp_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Distribution_Exemplar, attachments_),
  };
  Distribution_Exemplar_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      Distribution_Exemplar_descriptor_,
      Distribution_Exemplar::internal_default_instance(),
      Distribution_Exemplar_offsets_,
      -1,
      -1,
      -1,
      sizeof(Distribution_Exemplar),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Distribution_Exemplar, _internal_metadata_));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      Distribution_Exemplar_descriptor_, Distribution_Exemplar::internal_default_instance());
}
...
void protobuf_ShutdownFile_google_2fapi_2fdistribution_2eproto() {
  ...
  Distribution_Exemplar_default_instance_.Shutdown();
  delete Distribution_Exemplar_reflection_;
}
...
void protobuf_InitDefaults_google_2fapi_2fdistribution_2eproto_impl() {
  ...
  Distribution_Exemplar_default_instance_.DefaultConstruct();
  ...
  Distribution_Exemplar_default_instance_.get_mutable()->InitAsDefaultInstance();
}
...
void Distribution_Exemplar::SharedDtor() {
  if (this != &Distribution_Exemplar_default_instance_.get()) {
    delete timestamp_;
  }
}
...
const ::google::protobuf::Descriptor* Distribution_Exemplar::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Distribution_Exemplar_descriptor_;
}
...
::google::protobuf::internal::ExplicitlyConstructed<Distribution_Exemplar> Distribution_Exemplar_default_instance_;

Distribution_Exemplar* Distribution_Exemplar::New(::google::protobuf::Arena* arena) const {
  Distribution_Exemplar* n = new Distribution_Exemplar;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_attachments;
        break;
      }
      ...
      case 3: {
        if (tag == 26) {
         ...
         parse_loop_attachments:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtualNoRecursionDepth(
                input, add_attachments()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(26)) goto parse_loop_attachments;
...
void Distribution_Exemplar::SerializeWithCachedSizes(
  ...
  // repeated .google.protobuf.Any attachments = 3;
  for (unsigned int i = 0, n = this->attachments_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->attachments(i), output);
  }
...
::google::protobuf::uint8* Distribution_Exemplar::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->attachments_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, this->attachments(i), false, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:google.api.Distribution.Exemplar)
  ...
  // repeated .google.protobuf.Any attachments = 3;
  {
    unsigned int count = this->attachments_size();
...
void Distribution_Exemplar::UnsafeMergeFrom(const Distribution_Exemplar& from) {
  GOOGLE_DCHECK(&from != this);
...
void Distribution_Exemplar::InternalSwap(Distribution_Exemplar* other) {
  ...
  attachments_.UnsafeArenaSwap(&other->attachments_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
::google::protobuf::Metadata Distribution_Exemplar::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = Distribution_Exemplar_descriptor_;
  metadata.reflection = Distribution_Exemplar_reflection_;
  return metadata;
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(82)) goto parse_exemplars;
        break;
      }
      ...
      case 10: {
        if (tag == 82) {
         parse_exemplars:
          DO_(input->IncrementRecursionDepth());
         parse_loop_exemplars:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtualNoRecursionDepth(
                input, add_exemplars()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(82)) goto parse_loop_exemplars;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
void Distribution::SerializeWithCachedSizes(
  ...
  // repeated .google.api.Distribution.Exemplar exemplars = 10;
  for (unsigned int i = 0, n = this->exemplars_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      10, this->exemplars(i), output);
  }
...
::google::protobuf::uint8* Distribution::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->exemplars_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        10, this->exemplars(i), false, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:google.api.Distribution)
  ...
  // repeated .google.api.Distribution.Exemplar exemplars = 10;
  {
    unsigned int count = this->exemplars_size();
    total_size += 1UL * count;
    for (unsigned int i = 0; i < count; i++) {
      total_size +=
        ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
...
void Distribution::InternalSwap(Distribution* other) {
  ...
  exemplars_.UnsafeArenaSwap(&other->exemplars_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// optional double value = 1;
void Distribution_Exemplar::clear_value() {
  value_ = 0;
}
double Distribution_Exemplar::value() const {
  // @@protoc_insertion_point(field_get:google.api.Distribution.Exemplar.value)
  return value_;
}
void Distribution_Exemplar::set_value(double value) {
...
// optional .google.protobuf.Timestamp timestamp = 2;
bool Distribution_Exemplar::has_timestamp() const {
...
const ::google::protobuf::Timestamp& Distribution_Exemplar::timestamp() const {
  // @@protoc_insertion_point(field_get:google.api.Distribution.Exemplar.timestamp)
  return timestamp_ != NULL ? *timestamp_
                         : *::google::protobuf::Timestamp::internal_default_instance();
}
::google::protobuf::Timestamp* Distribution_Exemplar::mutable_timestamp() {
...
::google::protobuf::Timestamp* Distribution_Exemplar::release_timestamp() {
...
void Distribution_Exemplar::set_allocated_timestamp(::google::protobuf::Timestamp* timestamp) {
  delete timestamp_;
...
// repeated .google.protobuf.Any attachments = 3;
int Distribution_Exemplar::attachments_size() const {
  return attachments_.size();
}
void Distribution_Exemplar::clear_attachments() {
  attachments_.Clear();
}
const ::google::protobuf::Any& Distribution_Exemplar::attachments(int index) const {
  // @@protoc_insertion_point(field_get:google.api.Distribution.Exemplar.attachments)
  return attachments_.Get(index);
}
::google::protobuf::Any* Distribution_Exemplar::mutable_attachments(int index) {
  // @@protoc_insertion_point(field_mutable:google.api.Distribution.Exemplar.attachments)
  return attachments_.Mutable(index);
}
::google::protobuf::Any* Distribution_Exemplar::add_attachments() {
...
inline const Distribution_Exemplar* Distribution_Exemplar::internal_default_instance() {
  return &Distribution_Exemplar_default_instance_.get();
}
// -------------------------------------------------------------------
