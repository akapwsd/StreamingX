...
class Documentation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Documentation) */ {
 public:
  ...
  static const int kServiceRootUrlFieldNumber = 6;
  const ::std::string& service_root_url() const;
  void set_service_root_url(const ::std::string& value);
  void set_service_root_url(const char* value);
  void set_service_root_url(const char* value, size_t size);
  ::std::string* mutable_service_root_url();
  ::std::string* release_service_root_url();
...
inline void Documentation::set_service_root_url(const ::std::string& value) {
...
inline void Documentation::set_service_root_url(const char* value) {
...
inline void Documentation::set_service_root_url(const char* value, size_t size) {
