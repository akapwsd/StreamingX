...
void protobuf_AssignDesc_google_2fapi_2fservice_2eproto() {
  ...
  static const int Service_offsets_[26] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Service, billing_),
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Service, publishing_),
...
void protobuf_InitDefaults_google_2fapi_2fservice_2eproto_impl() {
  ...
  ::google::api::protobuf_InitDefaults_google_2fapi_2fbilling_2eproto();
  ::google::api::protobuf_InitDefaults_google_2fapi_2fclient_2eproto();
  ...
  ::google::api::protobuf_InitDefaults_google_2fapi_2fquota_2eproto();
  ::google::api::protobuf_InitDefaults_google_2fapi_2fsource_5finfo_2eproto();
...
void protobuf_AddDesc_google_2fapi_2fservice_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "rviceconfig;serviceconfig\242\002\004GAPIb\006proto3", 1760);
  ...
  ::google::api::protobuf_AddDesc_google_2fapi_2fbilling_2eproto();
  ::google::api::protobuf_AddDesc_google_2fapi_2fclient_2eproto();
  ...
  ::google::api::protobuf_AddDesc_google_2fapi_2fquota_2eproto();
  ::google::api::protobuf_AddDesc_google_2fapi_2fsource_5finfo_2eproto();
...
const int Service::kPublishingFieldNumber;
...
void Service::InitAsDefaultInstance() {
  ...
  quota_ = const_cast< ::google::api::Quota*>(
  ...
  billing_ = const_cast< ::google::api::Billing*>(
  ...
  source_info_ = const_cast< ::google::api::SourceInfo*>(
      ::google::api::SourceInfo::internal_default_instance());
  publishing_ = const_cast< ::google::api::Publishing*>(
      ::google::api::Publishing::internal_default_instance());
...
// @@protoc_insertion_point(message_clear_start:google.api.Service)
  ...
  control_ = NULL;
  if (GetArenaNoVirtual() == NULL && billing_ != NULL) delete billing_;
  billing_ = NULL;
  ...
  source_info_ = NULL;
  if (GetArenaNoVirtual() == NULL && publishing_ != NULL) delete publishing_;
  publishing_ = NULL;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(82)) goto parse_quota;
        break;
      }
      ...
      case 25: {
        ...
        if (input->ExpectTag(202)) goto parse_loop_monitored_resources;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(210)) goto parse_billing;
        break;
      }
      ...
      case 33: {
        ...
        if (input->ExpectTag(298)) goto parse_source_info;
        break;
      }
      ...
      case 37: {
        ...
        if (input->ExpectTag(362)) goto parse_publishing;
        break;
      }

      // optional .google.api.Publishing publishing = 45;
      case 45: {
        if (tag == 362) {
         parse_publishing:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_publishing()));
        } else {
          goto handle_unusual;
        }
...
::google::protobuf::uint8* Service::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_publishing()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        45, *this->publishing_, false, target);
  }
...
void Service::UnsafeMergeFrom(const Service& from) {
  ...
  if (from.has_publishing()) {
    mutable_publishing()->::google::api::Publishing::MergeFrom(from.publishing());
  }
...
void Service::InternalSwap(Service* other) {
  ...
  std::swap(billing_, other->billing_);
  ...
  std::swap(publishing_, other->publishing_);
...
// optional .google.api.Billing billing = 26;
bool Service::has_billing() const {
...
const ::google::api::Billing& Service::billing() const {
  // @@protoc_insertion_point(field_get:google.api.Service.billing)
  return billing_ != NULL ? *billing_
                         : *::google::api::Billing::internal_default_instance();
}
::google::api::Billing* Service::mutable_billing() {
...
::google::api::Billing* Service::release_billing() {
...
void Service::set_allocated_billing(::google::api::Billing* billing) {
  delete billing_;
  billing_ = billing;
  if (billing) {
...
// optional .google.api.Publishing publishing = 45;
bool Service::has_publishing() const {
  return this != internal_default_instance() && publishing_ != NULL;
}
void Service::clear_publishing() {
  if (GetArenaNoVirtual() == NULL && publishing_ != NULL) delete publishing_;
  publishing_ = NULL;
}
const ::google::api::Publishing& Service::publishing() const {
  // @@protoc_insertion_point(field_get:google.api.Service.publishing)
  return publishing_ != NULL ? *publishing_
                         : *::google::api::Publishing::internal_default_instance();
}
::google::api::Publishing* Service::mutable_publishing() {
  
  if (publishing_ == NULL) {
    publishing_ = new ::google::api::Publishing;
  }
  // @@protoc_insertion_point(field_mutable:google.api.Service.publishing)
  return publishing_;
}
::google::api::Publishing* Service::release_publishing() {
  // @@protoc_insertion_point(field_release:google.api.Service.publishing)
  
  ::google::api::Publishing* temp = publishing_;
  publishing_ = NULL;
  return temp;
}
void Service::set_allocated_publishing(::google::api::Publishing* publishing) {
  delete publishing_;
