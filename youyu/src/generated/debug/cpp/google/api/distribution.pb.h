...
class Distribution_Exemplar : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Distribution.Exemplar) */ {
 public:
  ...
  static const Distribution_Exemplar* internal_default_instance();

  void Swap(Distribution_Exemplar* other);

  // implements Message ----------------------------------------------

  inline Distribution_Exemplar* New() const { return New(NULL); }

  Distribution_Exemplar* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const Distribution_Exemplar& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<Distribution_Exemplar> Distribution_Exemplar_default_instance_;
...
inline void Distribution_Exemplar::clear_timestamp() {
...
inline void Distribution_Exemplar::clear_attachments() {
  attachments_.Clear();
}
