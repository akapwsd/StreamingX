...
class MonitoredResourceDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.MonitoredResourceDescriptor) */ {
 public:
  ...
  static const int kLaunchStageFieldNumber = 7;
...
class MonitoredResourceMetadata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.MonitoredResourceMetadata) */ {
 public:
  ...
  static const MonitoredResourceMetadata* internal_default_instance();
  ...
  inline MonitoredResourceMetadata* New() const { return New(NULL); }

  MonitoredResourceMetadata* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const MonitoredResourceMetadata& from);
  protected:
  ...
  private:
  void _slow_mutable_system_labels();
  void _slow_set_allocated_system_labels(
      ::google::protobuf::Arena* message_arena, ::google::protobuf::Struct** system_labels);
  ::google::protobuf::Struct* _slow_release_system_labels();
  public:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<MonitoredResourceMetadata> MonitoredResourceMetadata_default_instance_;
...
inline void MonitoredResourceMetadata::clear_system_labels() {
